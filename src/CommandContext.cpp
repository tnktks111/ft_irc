...
Client &CommandContext::client() { return _client; }
const Client &CommandContext::client() const { return _client; }

const Message &CommandContext::message() const { return _message; }

ServerContext &CommandContext::serverCtx() { return _serverCtx; }
const ServerContext &CommandContext::serverCtx() const { return _serverCtx; }
...
std::string CommandContext::prefix() const { return _client.getPrefix(); }
bool CommandContext::isRegistered() const { return _client.isRegistered(); }
